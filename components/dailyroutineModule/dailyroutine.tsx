    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.titleRow}>
        <TouchableOpacity onPress={() => router.back()} style={styles.backBtn}>
          <Ionicons name="chevron-back" size={35} color="#66BB6A" />
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  backBtn: { padding: 5 },
  headerCard: { flex: 1, backgroundColor: '#E0F9E9', padding: 15, borderRadius: 25, alignItems: 'center', marginLeft: 10 },
  ...
  cardFooter: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: '100%' },
  cardText: { fontSize: 18, fontWeight: 'bold', color: '#444', textAlign: 'center' },
  starBadge: { position: 'absolute', top: -10, right: -10, backgroundColor: '#FFF', padding: 5, borderRadius: 20, elevation: 8, zIndex: 10, borderWidth: 2, borderColor: '#FFD700' }
});