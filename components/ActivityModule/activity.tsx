...
const styles = StyleSheet.create({
  ...
  toggleContainer: { flexDirection: 'row', backgroundColor: '#E0E0E0', marginHorizontal: 20, marginTop: 10, borderRadius: 15, padding: 4 },
  ...
  instructionCard: { backgroundColor: '#E3F2FD', marginHorizontal: 20, marginTop: 3, borderRadius: 25, padding: 15, borderWidth: 3, borderColor: '#BBDEFB', elevation: 3, marginBottom: 15 },
  ...
  teacherBar: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 25, marginTop: 5, marginBottom: 10 },
